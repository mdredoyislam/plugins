        ...
        <div class="col-lg-6">
            <div class="rt-right">
                <table class="bmi-chart">
                    <tr>
                        <th><?php _e( 'BMI', 'gymat-core' );?></th>
                        <th><?php _e( 'Weight Status', 'gymat-core' );?></th>
                    </tr>
            ...
            <div class="bmi-chart-title"> 
				<h3><span><?php esc_html_e('BMR','gymat-core'); ?></span> <?php esc_html_e('Metabolic Rate','gymat-core'); ?> / <span><?php esc_html_e('BMI','gymat-core'); ?></span> <?php esc_html_e('Body Mass Index','gymat-core'); ?></h3>
			</div>
        </div>
    </div>
</div>