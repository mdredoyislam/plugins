...
<div class="pricing-box-2 default-pricing">
    <div class="item-content">
        <h3 class="item-title"><?php echo wp_kses_post($data['package_name']); ?></h3>
        <p>
            <?php echo wp_kses_post($data['package_text']); ?>
        </p>
        <h4 class="rt-price-box">
            <span><?php echo wp_kses_post($data['currency_icon']); ?></span><?php echo wp_kses_post($data['price']); ?>
            <sub class="month-price"><?php echo wp_kses_post($data['duration']); ?></sub>
        </h4>
    ...
    <div class="rt-background-img"><?php echo wp_kses_post($getimg);?></div>
</div>