...
?>
<div class="post-default post-grid-style2 post-multi-layout">
					...
					<div class="post-thumbnail">
						...
						<div class="entry-content">
							...
							<ul class="post-grid-meta">
								...
								<li class="post-author"><?php echo get_avatar(get_the_author_meta("ID"),32); ?><?php the_author_posts_link(); ?></li>
								<?php } ?>
