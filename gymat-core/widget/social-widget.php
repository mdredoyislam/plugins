...
/**
* About Widget with Social for footer by GymatTheme
**/
class GymatTheme_Social_Widget extends WP_Widget {

	public function __construct() {
		$widget_ops = array(
			'classname' => 'rt_footer_social_widget',
			'description' => esc_html__( 'Gymat : (For Footer) Social Link widget with Description' , 'gymat-core' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'rt-about-social', esc_html__( 'Gymat : Social Widget' , 'gymat-core' ), $widget_ops );
		$this->alt_option_name = 'gymat_about_widget';
	}
	...
	public function form( $instance ){
		$defaults = array(
			'title'       => esc_html__( 'About Company' , 'gymat-core' ),
			'description' => '',
			'facebook'    => '',
			'twitter'     => '',
			'skype'       => '',
		...
		$fields = array(
			...
			'linkedin'     => array(
				'label'    => esc_html__( 'LinkedIn URL', 'gymat-core' ),
				'type'     => 'url',
				),
			'pinterest'    => array(
				'label'    => esc_html__( 'Pinterest URL', 'gymat-core' ),
				'type'     => 'url',
				),
			'skype'        => array(
			...
			'instagram'    => array(
				'label'    => esc_html__( 'Instagram URL', 'gymat-core' ),
				'type'     => 'url',
				),
			'behance'      => array(
				'label'    => esc_html__( 'Behance Plus URL', 'gymat-core' ),
				'type'     => 'url',
				),
			'dribbble'     => array(
				'label'    => esc_html__( 'Dribbble Plus URL', 'gymat-core' ),
				'type'     => 'url',
				),
			);
